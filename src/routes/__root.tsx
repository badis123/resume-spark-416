...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Tailor your CV and cover letter to any job description. AI-powered ATS scoring, keyword gap analysis, and one-click PDF/DOCX exports." },
